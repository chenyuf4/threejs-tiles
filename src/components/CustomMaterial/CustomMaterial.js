  ...
  constructor() {
    super({
      ...
      uniforms: {
        ...
        translationX: { type: "f", value: 0.0 },
        translationY: { type: "f", value: 0.0 },
        translationZ: { type: "f", value: 0.0 },
        scaleX: { type: "f", value: 1.0 },
        scaleY: { type: "f", value: 1.0 },
        scaleZ: { type: "f", value: 1.0 },
        rotationX: { type: "f", value: 0 },
        rotationY: { type: "f", value: 0 },
        rotationZ: { type: "f", value: 0 },
      },
      vertexShader: [
        ...
        // Translate
        "mat4 tPos = mat4(vec4(0.0,0.0,0.0,0.0),",
